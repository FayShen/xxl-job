		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<#if loginUser.role == 1>
                    ...
                    <li class="nav-click <#if pageName == "namespace">active</#if>" ><a href="${request.contextPath}/namespace"><i class="fa fa-circle-o text-orange"></i><span>${I18n.namespace_field_name}</span></a></li>
				</#if>
